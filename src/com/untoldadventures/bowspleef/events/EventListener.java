...
public class EventListener implements Listener {
	...
	if (BowSpleef.invConfig.contains(player.getName()))
	{
		...
		// Replacing their Inventory
		Inventory inv1 = InventoryStringDeSerializer.StringToInventory(BowSpleef.invConfig.getString(winner.getName() + ".inventory"));
		winner.getInventory().setContents(inv1.getContents());
	...
	if (BowSpleef.invConfig.contains(player.getName()))
	{
	    ...
	    // Replacing their Inventory
	    Inventory inv1 = InventoryStringDeSerializer.StringToInventory(BowSpleef.invConfig.getString(player.getName() + ".inventory"));
